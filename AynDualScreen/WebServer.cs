...
namespace AynDualScreen
{
    ...
    /// dependable on the Android runtime the mod eventually has to run on. Every request is answered and the socket is
    /// closed; at ~10 polls/second over loopback that's nothing.
    /// </para>
